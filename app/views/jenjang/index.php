...
/**
 * File View untuk menampilkan daftar jenjang pendidikan
 *
 ...
 * @var app\models\search\JenjangSearch $searchModel - Model pencarian untuk filter tabel
 */

// === KONFIGURASI HALAMAN ===
$this->title = '🎓 Daftar Jenjang Pendidikan';
...
$this->registerCss("
    ...
    /* Styling untuk tombol 'Tambah Jenjang Baru' */
    .btn-tambah {
...
$gridColumns = [
    ...
    [
        // Kolom kode jenjang dengan styling badge
        ...
        'value' => function ($model) {
            return '<span class="badge badge-primary" style="font-size: 0.9rem; padding: 6px 12px; background: linear-gradient(45deg, #4db6ac, #26a69a); border-radius: 20px; color: white;">'
                . Html::encode($model->kode_jenjang) . '</span>';
        },
    ],
    [
        // Kolom nama jenjang dengan styling teks
        'attribute' => 'nama',
        'label' => '📚 Nama Jenjang',
...
<div class="jenjang-index">
    ...
    <div class="button-container">
        <!-- Tombol untuk menambah jenjang baru -->
        <?= GhostHtml::a(
            '<i class="fas fa-plus-circle"></i> Tambah Jenjang Baru',
            ['/jenjang/create'],
            [
                'class' => 'btn btn-tambah',
                'title' => 'Klik untuk menambah jenjang pendidikan baru'
            ]
        ) ?>
    ...
    <?= GridView::widget([
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        return Html::a(
                            ...
                            ['view', 'id' => $model->kode_jenjang],
                            [
                                'title' => 'Lihat detail jenjang: ' . $model->nama,
                                'data-toggle' => 'tooltip',
                                'data-placement' => 'top'
                            ]
                        );
                    ...
                    'update' => function ($url, $model) {
                        return Html::a(
                            ...
                            ['update', 'id' => $model->kode_jenjang],
                            [
                                'title' => 'Edit jenjang: ' . $model->nama,
                                'data-toggle' => 'tooltip',
                                'data-placement' => 'top'
                            ]
                        );
                    ...
                    'delete' => function ($url, $model) {
                        return Html::a(
                            ...
                            ['delete', 'id' => $model->kode_jenjang],
                            [
                                'title' => 'Hapus jenjang: ' . $model->nama,
                                'data-toggle' => 'tooltip',
                                'data-placement' => 'top',
                                'data' => [
                                    'confirm' => 'Apakah Anda yakin ingin menghapus jenjang "' . $model->nama . '"? Tindakan ini tidak dapat dibatalkan.',
                                    'method' => 'post',
                                ],
                            ]
                        );
        ...
        'summary' => '<div class="text-center mt-3 mb-3">
                        <strong>📊 Menampilkan <span style="color: #00897b;">{begin}-{end}</span> dari total <span style="color: #00bfa5;">{totalCount}</span> jenjang pendidikan</strong>
                    </div>',
